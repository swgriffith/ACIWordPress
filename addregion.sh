...
az network traffic-manager endpoint create --name $NAME-$LOC --profile-name WordpressTrafficMngr -g $RG --type externalEndpoints --target $NAME.$LOC.azurecontainer.io --priority $PRIORITY
